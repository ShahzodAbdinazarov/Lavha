...
> - **QOLGAN (owner emulyator E2E qilsa yaxshi):** ToS varag'i + rejim ekrani + banner + upload oqimi emulyatorда vizual tekshirilmagan (compile + pure + DB integration + string parity yashil).
